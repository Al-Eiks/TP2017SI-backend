...
module.exports = {
  ...
  create (name, characterClass, position, x, y, userId) {
    return DB.accessor.query(
  ...
  update (id, name, characterClass, position, x, y, characterID, userId) {
    return DB.accessor.query(`UPDATE characters SET name = ${name}, class = ${characterClass}, position = point(${x},${y}), user_id = ${userId} WHERE id = ${characterID} RETURNING *`,
      {
        characterID: id,
        name: name,
        characterClass: characterClass,
